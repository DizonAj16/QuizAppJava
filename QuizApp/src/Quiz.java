...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        image.setBounds(0, 5, 1180, 320);
        add(image);
        
        qno = new JLabel();
        qno.setBounds(50, 340, 50, 30);
        qno.setFont(new Font("Tahoma", Font.BOLD, 24));
        add(qno);
        
        question = new JLabel();
        question.setBounds(90, 340, 1000, 30);
        ...
        lifeline.setBounds(900, 520, 200, 40);
