...
public class Categories extends JFrame implements ActionListener {
    ...
    Categories(String name) {
        ...
        htmlq.setFont(new Font("Arial Black", Font.BOLD, 15));
        ...
        pythonq.setFont(new Font("Arial Black", Font.BOLD, 15));
        ...
        cplusplusq.setFont(new Font("Arial Black", Font.BOLD, 15));
